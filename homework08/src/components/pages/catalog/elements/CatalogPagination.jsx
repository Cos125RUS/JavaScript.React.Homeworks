...
const CatalogPagination = ({totalPages, currentPage = 1}) => {
    ...
    return (
        <nav className="catalog_page__nav">
            <div className="catalog_page__nav__box">
                <Link to={currentPage !== 1 ? `/catalog/page/${currentPage - 1}` : ''} className="catalog_page__nav__box__arrow">
                ...
                <Link to={currentPage !== totalPages ? `/catalog/page/${currentPage + 1}` : ''} className="catalog_page__nav__box__arrow">
                    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="14" viewBox="0 0 9 14"
                         fill="none">
