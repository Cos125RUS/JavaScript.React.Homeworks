                        ...
                        <nav className="menu center">
                            <div className="menu__left">
                                ...
                                <Link to="#" className="menu__link">
                                    <svg className="menu__img" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className="menu__right">
                                <div className="catalog menu__link">
                                    ...
                                    <label for="dropdown" className="catalog__dropdownLabel">
                                    ...
                                    <nav className="dropdown">
                                        ...
                                        <div className="catalog__categories">
                                            <div className="catalog__block">
                                                <Link to="catalog">
                                                    <h6 className="catalog__name">MAN</h6>
                                                </Link>
                                            ...
                                            <div className="catalog__block">
                                                <Link to="#">
                                                    <h6 className="catalog__name">WOMAN</h6>
                                                </Link>
                                                <ul className="catalog__list">
                                                    <li><Link to="#">Accessories</Link></li>
                                            ...
                                            <div className="catalog__block">
                                                <Link to="#">
                                                    <h6 className="catalog__name">KIDS</h6>
                                                </Link>
                                                <ul className="catalog__list">
                                                    <li><Link to="#">Accessories</Link></li>
                                                    <li><Link to="#">Jackets & Coats</Link></li>
                                ...
                                <Link to="registration" className="menu__link">
                                    <svg className="menu__img" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <Link to="cart" className="basket__link menu__link">
                                    <svg className="menu__img"
